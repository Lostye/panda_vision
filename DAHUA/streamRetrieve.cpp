...
//shark：流检索的构建函数，这个估计是参照demo的。并且初始化了CThread就是说用这个类的时候就已经创建了一个线程“streamRetrieve”
...
void StreamRetrieve::threadProc() {
    ...
    int lostNum = 0;
#endif
    static bool imageInit = true;//shark:是否初始化
