...
//    setROI(cameraSptr ,640, 300, 640, 480);//shark：xy确定矩形左上角坐标（建议值为640，300，640，480这样刚好框在中心）；
...
bool DHUA::discovery_device()
{
    ...
    cameraSptr = vCameraPtrList[1];//shark:把列表中客户输入ID对应的相机数据赋给cameraSptr
